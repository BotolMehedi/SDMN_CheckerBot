...
|
*/
$config['botToken'] = "5414397869:AAGkpalc1UeWa4x0j5Go7dZWnyHeGywrtZo";
...
$config['db']['username'] =  "sql6513360";
$config['db']['password'] =  "jA1un9A4Py";
$config['db']['database'] =  "sql6513360";
